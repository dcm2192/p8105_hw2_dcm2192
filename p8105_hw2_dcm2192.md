...
``` r
# bakers <- 
#   read_csv(file = "./data_hw2/gbb_datasets/bakers.csv") |> 
#   janitor::clean_names()
# 
# bakes <- 
#   read_csv(file = "./data_hw2/gbb_datasets/bakes.csv") |> 
#   janitor::clean_names()
# colnames(bakes)[3] <- "baker_name"
# 
# results <- 
#   read_csv(file = "./data_hw2/gbb_datasets/results.csv") |> 
#   janitor::clean_names()
#   
# colnames(results) <- c("series", "episode", "baker_name", "technical", "result")
# 
